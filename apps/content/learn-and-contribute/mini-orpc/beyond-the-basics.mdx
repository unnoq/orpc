...
- [ ] [Type-Safe Error](/docs/error-handling#typesafe-errors) Support ([reference](https://github.com/middleapi/orpc/blob/main/packages/server/src/procedure-client.ts#L113-L120))

- [ ] [RPC Protocol](/docs/rpc/protocol) Implementation ([reference](https://github.com/middleapi/orpc/blob/main/packages/client/src/adapters/standard/rpc-serializer.ts))
...
- [ ] [OpenAPI](/docs/openapi/routing) Support
