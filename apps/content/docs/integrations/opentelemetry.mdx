...
:::warning
Popular instrumentations that already handle context propagation include [@hono/otel](https://npmx.dev/package/@hono/otel), [@opentelemetry/instrumentation-http](https://npmx.dev/package/@opentelemetry/instrumentation-http), and [@opentelemetry/instrumentation-fetch](https://npmx.dev/package/@opentelemetry/instrumentation-fetch).
:::
