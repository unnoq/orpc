...
:::info
This guide shows how to wire oRPC into Nuxt manually. For a dedicated package with a Nuxt module, server route helpers, and typesafe `useAsyncData` utilities, see the [Nuxt Integration](/docs/integrations/nuxt).
:::
