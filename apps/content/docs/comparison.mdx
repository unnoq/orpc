...
Hono is excluded: its RPC types hit [documented limits](https://hono.dev/docs/recipes/rpc#known-issues) at this scale and need workarounds like pre-compiled client types, an issue oRPC avoids by design.
