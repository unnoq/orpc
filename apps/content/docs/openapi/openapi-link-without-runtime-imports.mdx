...
:::warning
The macro and everything it imports, including your router, run in Node or Bun while bundling. Keep these modules free of side effects such as connecting to a database, or your build will trigger them.
:::
