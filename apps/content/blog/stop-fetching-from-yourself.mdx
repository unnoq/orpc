...
:::tip
`typeof window` works in Next.js because the compiler replaces it per bundle. On Vite-based frameworks (SvelteKit, SolidStart, Nuxt, ...), guard with `import.meta.env.SSR` instead.
:::
