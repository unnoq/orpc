// Syncs GitHub sponsors into the README tables and the docs site's sponsor
// wall. Ads are deliberately not synced: apps/content/sponsors/ads.ts is
// hand-maintained, because a booked ad is a fixed position in the site's rails
// rather than a row in a feed, so the order it is authored in is the inventory.
