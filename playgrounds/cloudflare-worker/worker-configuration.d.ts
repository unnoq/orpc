/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 74bdd99a4488550e7cf660458c3d0152)
// Runtime types generated with workerd@1.20251125.0 2025-06-07 enable_request_signal
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "ChatRoom" | "PublisherDO";
	}
	interface Env {
		CHAT_ROOM: DurableObjectNamespace<import("./worker/index").ChatRoom>;
		PUBLISHER_DO: DurableObjectNamespace<import("./worker/index").PublisherDO>;
	}
}
